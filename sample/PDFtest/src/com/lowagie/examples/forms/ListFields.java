...
public class ListFields {
	...
	public static void main(String[] args) {
		...
		try {
			PrintStream stream = new PrintStream(new FileOutputStream(android.os.Environment.getExternalStorageDirectory() + java.io.File.separator + "droidtext" + java.io.File.separator + "listfields.txt"));
